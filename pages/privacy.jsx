  ...
  <Layout title="News">
      <div className="container text-center">
        ...
        <p>
          ...
          "you" or "your") and this Website operator ("Operator", "we", "us"
          or "our"). By accessing and using the Website and Services, you
          acknowledge that you have read, understood, and agree to be bound
          by the terms of this Agreement. This Policy does not apply to the
          practices of companies that we do not own or control, or to
          individuals that we do not employ or manage.{" "}
        </p>
        <h1 className="text-break"> Automatic collection of information </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Collection of personal information </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Use and processing of collected information </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Disclosure of information </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Retention of information </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Transfer of information </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> The rights of users </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> The right to object to processing </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Data protection rights under GDPR </h1>
        <p>
          {" "}
          If you are a resident of the European Economic Area (EEA), you
          have certain data protection rights and the Operator aims to take
        ...
        <h1 className="text-break"> How to exercise these rights </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Privacy of children </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Cookies </h1>
        <p>
          {" "}
        ...
        <p>
          ...
          and how to manage them, visit internetcookies.org{" "}
        </p>
        <h1 className="text-break"> Do Not Track signals </h1>
        <p>
          {" "}
          ...
          they move across different websites over time. The Website and
          Services do not track its visitors over time and across third
          party websites. However, some third party sites may keep track of
          your browsing activities when they serve you content, which
          enables them to tailor what they present to you.{" "}
        </p>
        <h1 className="text-break"> Email marketing </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Links to other resources </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Information security </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Data breach </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Changes and amendments </h1>
        <p>
          {" "}
          ...
          treat Personal Information. When we do, we will post a
        ...
        <h1 className="text-break"> Acceptance of this policy </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Contacting us </h1>
        <p>
          {" "}
