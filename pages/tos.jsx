  ...
  return (
    <Layout title="News">
      <div className="container text-center">
        <h1 className="text-break"> Terms and conditions</h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Prohibited uses </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Limitation of liability </h1>
        <p>
          {" "}
        ...
        <h1 className="text-break"> Acceptance of these terms </h1>
        <p>
          {" "}
